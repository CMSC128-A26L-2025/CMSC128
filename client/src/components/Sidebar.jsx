...
export default function Sidebar(currentPage){
  ...
  if (user?.user_type === 'Admin') {
    ...
    return(
        <>
            <div
            className="relative flex h-full w-full max-w-[20rem] flex-col bg-emerald-800 bg-clip-border p-4 text-white-700 shadow-xl shadow-blue-gray-900/5">
            ...
            <nav className="flex min-w-[240px] flex-col gap-2 p-2 font-sans text-base font-normal text-blue-gray-700">
                ...
                role="button"
                className="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none text-start hover:bg-emerald-900">                <div className="grid mr-4 place-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"
                    className="w-5 h-5">
                    <path fillRule="evenodd"
